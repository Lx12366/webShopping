<template>
    <el-card shadow="never" class="border-0">
        <!-- 新增|刷新 -->
        <ListHeader layout="create,delete,getList" @create="handleCreate" @getList="getData"
        ...
        <el-table ref="tableRef" :data="tableData" stripe style="width: 100%" v-loading="loading"
            ...
            <el-table-column label="状态" width="120">
                <template #default="{ row }">
                    <el-switch :modelValue="row.status" :active-value="1" :inactive-value="0" :loading="row.onStatus"
                        :disabled="row.super == 1" @change="handelStatus($event, row)">
                    </el-switch>
                </template>
            </el-table-column>
        ...
        <FormDrawer ref="formDrawerRef" commit="提交" :title="drawerTitle" @submit="handleSubmit" destroyOnClose>
