<template>
    <el-card shadow="never" class="border-0">
        ...
        <!-- //el tree属性  node-key(唯一标识)和:default-expanded-keys(默认展开)要一一对应 -->
        ...
        <FormDrawer ref="formDrawerRef" commit="提交" :title="drawerTitle" @submit="handleSubmit">
...
const {
    ...
    getList: getRuleList,
    //回调传回res  设置defaultExpandedKeys的值为id数组
